RailsDesigner.configure do |config|
  ...
  # See the docs for all the details: https://railsdesigner.com/docs/view-helpers/.
  config.view_helpers = ["component", "stream_notification", "string_to_color", "form_label", "form_builder"]

  # Override the styles for Rails Designer's FormBuilder.
  # If you need to update an element once, use: `class` instead, like so:
  # `form.text_field :name, class: "your-custom-classes-here"`.
  ...
  # config.form_builder.radio_pills_css = ""
  ...
  # Set a different destination directory for the layouts,
  # the default is `app/views/layouts`
  #
  # config.layouts_destination_directory = app/view/custom/layouts

  # Hide the feedback button in the bottom-left of the navigation.
  # The default is `false`.
  # config.disable_feedback_buttons = true
end
